...
# args: transcript, label, folder, scratch_notes, extra_context, language, date_str
GenerateNotesCallable = Callable[[str, str, str, str, str, str, str], str]
# args: transcript
SuggestTermsCallable = Callable[[str], List[Dict]]


def generate_notes(transcript: str, label: str = "", folder: str = "", scratch_notes: str = "", extra_context: str = "", language: str = "Czech", date_str: str = "") -> str:
    ...
    if provider == "anthropic":
        ...
        return _gen(transcript, label, folder, scratch_notes, extra_context, language, date_str)
    if provider == "openai":
