...
payload = {"title": "Fix for issue #30", "body": "Closes #30\n\nImplemented automated fix.", "head": "KartavyaDikshit:fix-issue-30", "base": "main"}
req = urllib.request.Request("https://api.github.com/repos/kjarkovska/fusemark/pulls", data=json.dumps(payload).encode(), headers={'Authorization': f'token {token}', 'Accept': 'application/vnd.github.v3+json', 'Content-Type': 'application/json'}, method='POST')
try:
